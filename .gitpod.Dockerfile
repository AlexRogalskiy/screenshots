...
LABEL io.nullables.screenshots.build-date=$BUILD_DATE
LABEL io.nullables.screenshots.name="screenshots"
LABEL io.nullables.screenshots.description="Styled screenshots"
LABEL io.nullables.screenshots.url="https://nullables.io/"
LABEL io.nullables.screenshots.vcs-ref=$VCS_REF
LABEL io.nullables.screenshots.vcs-url="https://github.com/AlexRogalskiy/screenshots"
LABEL io.nullables.screenshots.vendor="Nullables.io"
LABEL io.nullables.screenshots.version=$VERSION
